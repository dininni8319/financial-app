...
const Row3 = () => {
  ...
  const pieColors = [palette.primary[500]]
    ...
    <>
      ...
      <BoxHeader title="Overall Summary and Explanation Data" sideText="+15%" />
         ...
         <Typography margin="0 1rem" variant="h6">
            ...
            Vero totam labore ducimus. Ratione nemo fugiat cumque perferendis, pariatur doloribus, 
            optio culpa nesciunt facilis ipsum deleniti harum, architecto fuga laboriosam voluptatum.
         </Typography>
      </DashboardBox>
    </>
  )
